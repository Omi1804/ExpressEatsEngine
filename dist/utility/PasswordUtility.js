...
const GenerateSignature = (payload) => {
    const signature = jsonwebtoken_1.default.sign(payload, config_1.JWT_SECRET, { expiresIn: "1d" });
    return signature;
};
...
const ValidateSignature = (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (signature) {
        const payload = (yield jsonwebtoken_1.default.verify(signature.split(" ")[1], config_1.JWT_SECRET));
        req.user = payload;
        return true;
    }
    return false;
